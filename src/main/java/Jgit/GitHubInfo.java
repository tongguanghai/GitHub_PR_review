...
//                System.out.println( "提交信息： "+commit.getCommitShortInfo().getMessage());
                ...
                demands [count][0]=commitInfo.getCommitName();
                demands [count][1]=commit.getSHA1();
                list.add(count,commitInfo.getCommitName());
                list.add(count,commit.getSHA1());
...
//                System.out.println("Patch:  "+changeContent);
            ...
            GitHubInfo wa = new GitHubInfo();
            wa.writeArrayToExcel(demands, "mytxt.xls");
            //System.out.println(count);
            return commitInfos;
        }catch (Exception e){
